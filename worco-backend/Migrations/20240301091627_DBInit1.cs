        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    place_number = table.Column<int>(type: "integer", nullable: false),
                    is_delete_place = table.Column<bool>(type: "boolean", nullable: false),
                    name_map = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ReservationsPlaces_Places_place_id",
                        column: x => x.place_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationsPlaces_account_id",
                table: "ReservationsPlaces",
                column: "account_id");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationsPlaces_place_id",
                table: "ReservationsPlaces",
                column: "place_id");
        }
